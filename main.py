...
output = ctk.CTkTextbox(root, width=490, height=50, font=(('Roboto', 70)), corner_radius=1)
...
button_empty = ctk.CTkButton(root, text=" ", command=print("Nothing :D"), width=120, height=80, font=("Roboto", 22), corner_radius=1)
...
button_point.grid(row=10, column=1, padx=1, pady=1)

button_empty = ctk.CTkButton(root, text=" ", command=print("Nothing :D"), width=120, height=80, font=("Roboto", 22), corner_radius=1)
button_empty.grid(row=10, column=2, padx=1, pady=1)
